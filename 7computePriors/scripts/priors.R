...
doh1 <- read.delim((file = "scripts/doh-data-drop/211102.DOH.batch0.csv") , sep = ',', header = TRUE)
doh2 <- read.delim((file = "scripts/doh-data-drop/211102.DOH.batch1.csv") , sep = ',', header = TRUE)
doh3 <- read.delim((file = "scripts/doh-data-drop/211102.DOH.batch2.csv") , sep = ',', header = TRUE)
doh <- rbind(doh1, doh2, doh3)
